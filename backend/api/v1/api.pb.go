...
const (
	...
	MarkerType_MARKER_TYPE_NAME_SUPER  MarkerType = 1
	MarkerType_MARKER_TYPE_BIBLE_VERSE MarkerType = 2
	MarkerType_MARKER_TYPE_SONG        MarkerType = 3
	MarkerType_MARKER_TYPE_CHAPTER     MarkerType = 4
	MarkerType_MARKER_TYPE_CUSTOM      MarkerType = 5
)
...
var (
	MarkerType_name = map[int32]string{
		...
		1: "MARKER_TYPE_NAME_SUPER",
		2: "MARKER_TYPE_BIBLE_VERSE",
		3: "MARKER_TYPE_SONG",
		4: "MARKER_TYPE_CHAPTER",
		5: "MARKER_TYPE_CUSTOM",
	}
...
type MarkerSource int32

const (
	MarkerSource_MARKER_SOURCE_UNSPECIFIED MarkerSource = 0
	MarkerSource_MARKER_SOURCE_IMPORTED    MarkerSource = 1
	MarkerSource_MARKER_SOURCE_MANUAL      MarkerSource = 2
)

// Enum value maps for MarkerSource.
var (
	MarkerSource_name = map[int32]string{
		0: "MARKER_SOURCE_UNSPECIFIED",
		1: "MARKER_SOURCE_IMPORTED",
		2: "MARKER_SOURCE_MANUAL",
	}
	MarkerSource_value = map[string]int32{
...
func (x MarkerSource) Enum() *MarkerSource {
	p := new(MarkerSource)
	*p = x
	return p
}

func (x MarkerSource) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (MarkerSource) Descriptor() protoreflect.EnumDescriptor {
	return file_api_v1_api_proto_enumTypes[3].Descriptor()
}

func (MarkerSource) Type() protoreflect.EnumType {
	return &file_api_v1_api_proto_enumTypes[3]
}

func (x MarkerSource) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use MarkerSource.Descriptor instead.
func (MarkerSource) EnumDescriptor() ([]byte, []int) {
...
func (x *Marker) GetStart() float64 {
	if x != nil {
		return x.Start
	}
	return 0
...
func (x *Marker) GetSource() MarkerSource {
	if x != nil {
		return x.Source
	}
...
func (x *GetMarkersResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type SubmitMarkersRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	VXID          string                 `protobuf:"bytes,1,opt,name=VXID,proto3" json:"VXID,omitempty"`
...
func (x *SubmitMarkersRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *SubmitMarkersRequest) GetMarkers() []*Marker {
	if x != nil {
		return x.Markers
	}
	return nil
...
var file_api_v1_api_proto_goTypes = []any{
	...
	(MarkerType)(0),                      // 2: api.v1.MarkerType
	(MarkerSource)(0),                    // 3: api.v1.MarkerSource
	(*BMMPermission)(nil),                // 4: api.v1.BMMPermission
	(*TranscriptionPermission)(nil),      // 5: api.v1.TranscriptionPermission
	(*ExportPermission)(nil),             // 6: api.v1.ExportPermission
	(*VBExportPermission)(nil),           // 7: api.v1.VBExportPermission
	(*CantemoPermission)(nil),            // 8: api.v1.CantemoPermission
	(*VaultPermission)(nil),              // 9: api.v1.VaultPermission
...
var file_api_v1_api_proto_depIdxs = []int32{
	...
	5,  // 1: api.v1.Permissions.transcription:type_name -> api.v1.TranscriptionPermission
	6,  // 2: api.v1.Permissions.export:type_name -> api.v1.ExportPermission
	7,  // 3: api.v1.Permissions.vb_export:type_name -> api.v1.VBExportPermission
	...
	27, // 19: api.v1.LanguageList.Languages:type_name -> api.v1.Language
	30, // 20: api.v1.Transcription.segments:type_name -> api.v1.Segments
	31, // 21: api.v1.Segments.words:type_name -> api.v1.Words
	0,  // 22: api.v1.GetBMMTranscriptionRequest.environment:type_name -> api.v1.BmmEnvironment
	29, // 23: api.v1.SubmitTranscriptionRequest.transcription:type_name -> api.v1.Transcription
	38, // 24: api.v1.GetExportConfigResponse.languages:type_name -> api.v1.ExportLanguage
	37, // 25: api.v1.GetExportConfigResponse.resolutions:type_name -> api.v1.ExportResolution
	39, // 26: api.v1.GetExportConfigResponse.subclips:type_name -> api.v1.ExportSubclip
	42, // 27: api.v1.StartExportRequest.resolutions:type_name -> api.v1.ExportResolutionSelection
	52, // 28: api.v1.ResolveAssetsResponse.assets:type_name -> api.v1.ResolvedAsset
	1,  // 29: api.v1.TriggerCantemoActionRequest.action:type_name -> api.v1.CantemoAction
	56, // 30: api.v1.VaultSearchResponse.items:type_name -> api.v1.VaultItem
	57, // 31: api.v1.VaultSearchResponse.facets:type_name -> api.v1.VaultFacet
