...
type ImportEditorialMarkersFromPlayoutRequest struct {
	...
	RecordingStart *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=recording_start,json=recordingStart,proto3" json:"recording_start,omitempty"`
	RecordingEnd   *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=recording_end,json=recordingEnd,proto3" json:"recording_end,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *ImportEditorialMarkersFromPlayoutRequest) GetRecordingStart() *timestamppb.Timestamp {
	if x != nil {
...
func (x *ImportEditorialMarkersFromPlayoutRequest) GetRecordingEnd() *timestamppb.Timestamp {
	if x != nil {
...
type GetRecordingWindowRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *GetRecordingWindowRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type GetRecordingWindowResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *GetRecordingWindowResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *GetRecordingWindowResponse) GetEnd() *timestamppb.Timestamp {
	if x != nil {
		return x.End
	}
	return nil
...
func (x *GetRecordingWindowResponse) GetSource() string {
	if x != nil {
		return x.Source
	}
	return ""
...
func (x *GetRecordingWindowResponse) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
func (x *GetRecordingWindowResponse) GetDurationMs() int64 {
	if x != nil {
		return x.DurationMs
	}
	return 0
...
const file_api_v1_api_proto_rawDesc = "" +
	...
	"\amarkers\x18\x01 \x03(\v2\x17.api.v1.EditorialMarkerR\amarkers\"\xdb\x01\n" +
	"(ImportEditorialMarkersFromPlayoutRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x19\n" +
	"\bevent_id\x18\x02 \x01(\tR\aeventId\x12C\n" +
	"\x0frecording_start\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\x0erecordingStart\x12?\n" +
	"\rrecording_end\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\frecordingEnd\":\n" +
	"\x19GetRecordingWindowRequest\x12\x1d\n" +
	"\n" +
	"session_id\x18\x01 \x01(\tR\tsessionId\"\xcb\x01\n" +
	"\x1aGetRecordingWindowResponse\x120\n" +
	...
	"\x1fCANTEMO_ACTION_UPDATE_RELATIONS\x10\x042\xbb\x17\n" +
	"\n" +
	"APIService\x125\n" +
	...
	"\x11ListPlayoutEvents\x12 .api.v1.ListPlayoutEventsRequest\x1a!.api.v1.ListPlayoutEventsResponse\"\x00\x12]\n" +
	"\x12GetRecordingWindow\x12!.api.v1.GetRecordingWindowRequest\x1a\".api.v1.GetRecordingWindowResponse\"\x00B\x1eZ\x1cbcc-media-tools/api/v1;apiv1b\x06proto3"
...
var file_api_v1_api_proto_depIdxs = []int32{
	...
	33, // 56: api.v1.APIService.GetTranscriptionPreview:input_type -> api.v1.GetPreviewRequest
	33, // 57: api.v1.APIService.GetShortsPreview:input_type -> api.v1.GetPreviewRequest
	36, // 58: api.v1.APIService.SubmitTranscription:input_type -> api.v1.SubmitTranscriptionRequest
	18, // 59: api.v1.APIService.GetYears:input_type -> api.v1.GetYearsRequest
	19, // 60: api.v1.APIService.GetAlbums:input_type -> api.v1.GetAlbumsRequest
	22, // 61: api.v1.APIService.GetAlbumTracks:input_type -> api.v1.GetAlbumTracksRequest
	23, // 62: api.v1.APIService.GetPodcastTracks:input_type -> api.v1.GetPodcastTracksRequest
	24, // 63: api.v1.APIService.GetLanguages:input_type -> api.v1.GetAvailableLanguagesRequest
	35, // 64: api.v1.APIService.GetBMMTranscription:input_type -> api.v1.GetBMMTranscriptionRequest
	37, // 65: api.v1.APIService.SubmitShort:input_type -> api.v1.SubmitShortRequest
	...
	34, // 94: api.v1.APIService.GetTranscriptionPreview:output_type -> api.v1.Preview
	34, // 95: api.v1.APIService.GetShortsPreview:output_type -> api.v1.Preview
	87, // 96: api.v1.APIService.SubmitTranscription:output_type -> api.v1.Void
	17, // 97: api.v1.APIService.GetYears:output_type -> api.v1.GetYearsResponse
	21, // 98: api.v1.APIService.GetAlbums:output_type -> api.v1.AlbumsList
	26, // 99: api.v1.APIService.GetAlbumTracks:output_type -> api.v1.TracksList
	26, // 100: api.v1.APIService.GetPodcastTracks:output_type -> api.v1.TracksList
	27, // 101: api.v1.APIService.GetLanguages:output_type -> api.v1.LanguageList
	30, // 102: api.v1.APIService.GetBMMTranscription:output_type -> api.v1.Transcription
	87, // 103: api.v1.APIService.SubmitShort:output_type -> api.v1.Void
